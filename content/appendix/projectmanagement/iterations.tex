...
Im Projektverwaltungstool (siehe \nameref{sec:tools}) ist ergänzend eine detaillierte Arbeitspaketplanung mit aktuellem Arbeitsstatus verfügbar.
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\caption{Iterationsübersicht mit Meilensteinen, Kalenderwochen Februar bis Juni 2013}
\end{figure}
