...
Das ``Link''-Prinzip ist eng verbunden mit Abschnitt \ref{sec:principle-rp10-browser-controls}, ``\nameref{sec:principle-rp10-browser-controls}'' und stellt die Anforderung, dass jede Seite eindeutig per \gls{URL} identifizierbar sein muss.
