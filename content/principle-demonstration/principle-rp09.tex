...
Das Weiterleiten auf die Rangliste ist nur möglich, weil der Server die \gls{URL} vor dem Login in die Session speichert (siehe Quellcode \ref{lst:router-set-redirecturl}).
