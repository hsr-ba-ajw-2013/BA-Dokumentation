...
Die geplante Umsetzung ist so implementiert worden. Als Beispiel zeigt Quelltext \ref{lst:roomiesCommunityModel} ein \emph{Barefoot.Model} \cite{barefootModel}, welches eine URL zur API definiert und über diese synchronisiert werden kann.
