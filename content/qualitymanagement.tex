...
Die Code Style Guideline ist im Anhang \ref{sec:coding-guidelines} ``\nameref{sec:coding-guidelines}'' einsehbar.
...
Weiter wird jeweils eine aktuelle Version der Quellcode-Dokumentation mittels NaturalDocs erstellt.
