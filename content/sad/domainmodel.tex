...
Rules (Regeln) bestimmen, wann Resident Achievement erreicht haben und bekommen. Diese Regeln können Zeit-basiert (z.B. ist kürzlich einer \gls{WG} beigetreten), Punkte-basiert (z.B. hat 10 Aufgaben erledigt) oder auch bei Komplettierung (z.B. hat sich registriert) vergeben werden.
