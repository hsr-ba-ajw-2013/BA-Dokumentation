...
Quelltext \ref{lst:callbackHellFunctional} zeigt einen Ausschnitt der überarbeiteten Version von \ref{lst:callbackHell}. Es wurde der funktionale Ansatz für das Refactoring gewählt.
