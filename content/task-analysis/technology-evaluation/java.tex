...
\tableheadcolor
	...
	\tabularnewline
\tablebody
	\textit{Studienarbeit-Zusammenstellung}	& \threeStars 	& \threeStars	& 				& 				& \threeStars	& \twoStars 	& 11 \tabularnewline
	\textit{Spring}							&		 		&				& \twoStars		& \threeStars	&				& \oneStar		& 6 \tabularnewline
	\textit{Plain JEE} 						& 			 	& \twoStars		& \threeStars	& \threeStars	&				& \threeStars	& 8 \tabularnewline
	\textit{Vaadin} 						& \oneStar 		& 				& \threeStars	& \twoStars		&				& \threeStars	& 8 \tabularnewline
	\textit{Play! Framework} 				& \oneStar 		& 				& \twoStars		& \twoStars		&				& \threeStars	& 9 \tabularnewline
\tableend
\end{tabularx}
