...
\begin{enumerate}
	...
	Tower.js, derby, Geddy und Sails setzen auf einer höheren Abstraktionsebene an und maskieren zugrundeliegende MVC-Komplexität. \\ Im Falle von derby und Sails wird sogar Express.js als Basis verwendet.
\end{enumerate}
...
Nach Punkten gewinnt Express.js ganz klar die Ausscheidung in der Kategorie JavaScript. Aufgrund der interessanten Ansätze welche Sails wählt, und im Vergleich zu Express.js bereits ein \gls{ORM} mitbringt, schickt JavaScript jedoch \emph{Sails} in die finale Technologieevaluationsrunde.
