...
\textit{TK1} &
	Eigenkonzepte &
	Wie viele eigene Konzepte \& Ideen bringt eine Technologie resp. ein Framework mit? Viele spezifische Konzepte bedeuten eine steile Lernkurve für Neueinsteiger und sind darum tendenziell ungeeignet für die Verwendung in einem Unterrichtsmodul. \emph{Hohe Bewertung = Wenig Eigenkonzepte}&
...
\textit{TK4} &
	Aktualität &
	Diese Arbeit befasst sich um ``moderne Web-Applikationen''. So sollte auch die zu verwendende Technologie gewissermassen nicht von ``vorgestern'' sein. \emph{Hohe Bewertung = Hohe Aktualität}&
