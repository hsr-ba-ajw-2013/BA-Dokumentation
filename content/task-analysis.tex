...
\begin{enumerate}
	...
	\item Der zu erstellende Quellcode soll \emph{State Of The Art} Architekturprinzipien (siehe Anhang \ref{sec:appendix-architectural-principles}) exemplarisch darstellen und der interessierten Fachperson als auch Studenten der Vorlesung \emph{Internettechnologien} als Anschauungsmaterial dienen können.
\end{enumerate}
...
\begin{enumerate}
	...
	\item Wie werden die ROCA-Architekturprinzipien und Tilkovs ``10 Empfehlungen'' am optimalsten auf die Beispielapplikation abgebildet?
\end{enumerate}
