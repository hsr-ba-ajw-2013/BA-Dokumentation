...
\tablebody
	...
	\textit{A25} & M2 & \gls{SAD}
		& Beschreibung der angestrebeten Architektur für die Beispielapplikation.\tabularnewline
	...
	\textit{A81} & M8 & Vagrant Paket
		& \gls{VM}-Image mit lauffähger Version der Beispielapplikation. \emph{Typ: Vagrant Image}\tabularnewline
	...
	\textit{A83} & M8 & Installationsanleitung
		& Anleitung wie die verschiedenen Deploymentpakete (Artefakte \emph{A80-82}) eingesetzt/installiert werden können.\tabularnewline

	\textit{A100} & M10 & Dokumentation
