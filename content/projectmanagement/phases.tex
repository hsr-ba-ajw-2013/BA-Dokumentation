...
\tablebody
	...
	\textit{Construction 3} & 2 Wochen
		& Umsetzung des \emph{Gameification}-Teils der Applikation. Qualitätssicherung in Form von Reviews \& Unit Testing.\tabularnewline
	...
	\textit{Transition} & 1 Wochen
		& Abschliessende Bugfixing-Arbeiten. Codefreeze und Erstellung von Deploymentpaketen.\tabularnewline
...
Eine Ausnahme bildet der Meilenstein \emph{M9: Abgabe HSR Artefakte}. Zu diesem Zeitpunkt müssen die entsprechenden Artefakte \emph{A100} sowie \emph{A101} im HSR abgabebereit sein.
