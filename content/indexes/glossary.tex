...
\newglossaryentry{AJAX}{
	name={AJAX},
	description={Ajax ist ein Apronym für die Wortfolge ``Asynchronous JavaScript and XML''. Es bezeichnet ein Konzept der asynchronen Datenübertragung zwischen einem Internetbrowser und einem Webserver. \cite{AJAX}}
}
