...
\newglossaryentry{Scaffolding}{
	name=Scaffolding,
	description={Scaffolding ermöglicht die Erstellung von Basis-Strukturen einer Applikation per Commandline. Populär wurde es u.a. mittels Ruby on Rails \cite{RoR}}
}
...
\newglossaryentry{RealTime}{
	name={Real-Time},
	description={Mit ``Real-Time'' ist in Web-Applikationen meistens ``Soft-Real-Time'' gemeint. Antwortzeiten sind somit nicht garantiert, sind aber möglichst klein gehalten (im Milisekunden-Bereich). Mittels Websockets oder BOSH \gls{BOSH} sind solche Applikationen im Web realisierbar.}
}